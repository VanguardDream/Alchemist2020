###########################################################################
## Makefile generated for component 'simulink_controller'. 
## 
## Makefile     : simulink_controller.mk
## Generated on : Mon Mar 08 19:03:08 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/simulink_controller.elf
...
PRODUCT_NAME              = simulink_controller
MAKEFILE                  = simulink_controller.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simulink_controller.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=simulink_controller -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/simulink_controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/simulink_controller_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/simulink_controller_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_controller.o : $(START_DIR)/simulink_controller_ert_rtw/simulink_controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_controller_data.o : $(START_DIR)/simulink_controller_ert_rtw/simulink_controller_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
